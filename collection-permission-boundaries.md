...
**pinnedBy 字段隔离**: 查询时就通过 `where: { id: userId }` 过滤，只返回当前用户的 pin 记录，查询后再次做防御性过滤 ([getLinkById.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/links/linkId/getLinkById.ts#L33-L43)):
...
**getLinks** ([getLinks.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/links/getLinks.ts#L93-L110)):
...
**searchLinks** ([searchLinks.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/search/searchLinks.ts#L99-L113)):
...
**getPublicCollection** ([getPublicCollection.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/public/collections/getPublicCollection.ts#L4-L8)):
```typescript
where: {
  id,
...
**getLinkById (公开)** ([getLinkById.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/public/links/linkId/getLinkById.ts#L10-L16)):
```typescript
where: {
  id: linkId,
  collection: {
...
在 [postCollection.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/collections/postCollection.ts#L61-L120) 中：
...
| 权限核心 | [getPermission.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/getPermission.ts) | 服务端权限查询核心函数（注意 collectionId 和 linkId 分支行为不同） |
...
| 集合操作 | [postCollection.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/collections/postCollection.ts) | 创建/子集合权限继承（仅继承 rootOwner，不自动继承成员） |
| 集合操作 | [updateCollectionById.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/collections/collectionId/updateCollectionById.ts) | 更新集合与权限向下传播（propagateToSubcollections） |
...
| 链接操作 | [getLinkById.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/links/linkId/getLinkById.ts) | 获取链接详情（权限检查在调用方） |
| 链接操作 | [getLinks.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/links/getLinks.ts) | 链接列表查询与权限过滤 |
| 链接操作 | [searchLinks.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/search/searchLinks.ts) | 搜索查询与权限过滤 |
...
| 公开集合 | [getPublicCollection.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/public/collections/getPublicCollection.ts) | 公开集合查询 |
| 公开链接 | [getLinkById.ts](file:///d:/fz/0601/solo-dogfeeding/code/37-linkwarden/apps/web/lib/api/controllers/public/links/linkId/getLinkById.ts) | 公开链接查询 |
